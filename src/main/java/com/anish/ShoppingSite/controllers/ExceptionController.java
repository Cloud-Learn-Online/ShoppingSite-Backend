...
public class ExceptionController extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<MyResponce<String>> userNotFoundException(UserNotFoundException e) {
		...
		return new ResponseEntity<MyResponce<String>>(
				new MyResponce<String>(new Date(), "failed", e.getMessage(), HttpStatus.NOT_FOUND),
	...
	public ResponseEntity<MyResponce<String>> userServiceException(UserServiceExcpetion e) {
		...
		return new ResponseEntity<MyResponce<String>>(
				new MyResponce<String>(new Date(), "failed", e.getMessage(), HttpStatus.BAD_REQUEST),
	...
	public ResponseEntity<MyResponce<String>> shoppingServiceException(ShoppingCartException e) {
		...
		return new ResponseEntity<MyResponce<String>>(
				new MyResponce<String>(new Date(), "success", e.getMessage(), HttpStatus.OK),
				HttpStatus.OK);
	}
